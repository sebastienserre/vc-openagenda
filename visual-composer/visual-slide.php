	...
	class VcOpenAgenda {
		...
		public function vc_openagenda_mapping() {
			vc_map(
				...
				array(
					'name'        => __( 'OpenAgenda Slider', 'vc-openagenda' ),
					'base'        => 'vc_openagenda_slider',
					'description' => __( 'Display your openAgenda in a slider view', 'vc-openagenda' ),
					...
					'params'      => array(
						...
						array(
							...
							'holder'      => 'h3',
							'class'       => 'title-class',
							'heading'     => __( 'Agenda Slug', 'vc-openagenda' ),
							'param_name'  => 'agenda_slug',
							'value'       => __( 'my-agenda-slug', 'vc-openagenda' ),
							'description' => __( 'The Slug of your agenda in openagenda. For example, if your Openagenda URL is https://openagenda.com/my-great-calendar, then the slug is my-great-calendar', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
						...
						array(
							...
							'holder'      => 'p',
							'class'       => 'title-class',
							'heading'     => __( 'Color to Title', 'vc-openagenda' ),
							'param_name'  => 'agenda_title_color',
							'value'       => '#000000',
							'description' => __( 'Select the color for the  title part between %', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
						...
						array(
							...
							'holder'      => 'p',
							'class'       => 'title-class',
							'heading'     => __( 'Background color', 'vc-openagenda' ),
							'param_name'  => 'agenda_date_color',
							'value'       => '#00bfff',
							'description' => __( 'Date Box background color', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
						...
						array(
							...
							'holder'      => 'p',
							'class'       => 'title-class',
							'heading'     => __( 'text color', 'vc-openagenda' ),
							'param_name'  => 'agenda_date_text_color',
							'value'       => '#000000',
							'description' => __( 'Date Box text color', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
						...
						array(
							...
							'holder'      => 'p',
							'class'       => 'title-class',
							'heading'     => __( 'tag Filter', 'vc-openagenda' ),
							'param_name'  => 'agenda_tag',
							'value'       => __( '', 'vc-openagenda' ),
							'description' => __( 'Tag Filter', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
						...
						array(
							...
							'holder'      => 'p',
							'class'       => 'title-class',
							'heading'     => __( 'Cat Filter', 'vc-openagenda' ),
							'param_name'  => 'agenda_cat',
							'value'       => __( '', 'vc-openagenda' ),
							'description' => __( 'Cat Filter', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
						...
						array(
							...
							'holder'      => 'p',
							'class'       => 'title-class',
							'heading'     => __( 'search', 'vc-openagenda' ),
							'param_name'  => 'agenda_search',
							'value'       => __( '', 'vc-openagenda' ),
							'description' => __( 'search Filter', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
						...
						array(
							...
							'holder'      => 'p',
							'class'       => 'title-class',
							'heading'     => __( 'Display venue', 'vc-openagenda' ),
							'param_name'  => 'agenda_lieu',
							'value'       => __( '', 'vc-openagenda' ),
							'description' => __( 'Display Venue', 'vc-openagenda' ),
							'admin_label' => false,
							'weight'      => 0,
							'group'       => 'Agenda',
						),
		...
		public function p2p5_openagenda_view( $decoded_body, $atts ) {
			...
			if ( $decoded_body['total'] == 0 ) {
				...
				$html .= '<p>' . __( 'Sorry, no events found', 'vc-openagenda' ) . '</p>';
			} else {
